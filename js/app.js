 ...
 */
        ...
        $("#attachment").on("change", (function(e) {
            for (var i = 0; i < this.files.length; i++) {
                ...
                fileBloc.append('<span class="file-delete"><span><i class="bi bi-x"></i></span></span>').append(fileName);
            ...
            $("span.file-delete").click((function() {
                ...
                $(this).parent().remove();
                for (let i = 0; i < dt.items.length; i++) if (name === dt.items[i].getAsFile().name) {
                    dt.items.remove(i);
                    continue;
                }
        ...
        $("#file-selector").on("change", (function(e) {
            for (var i = 0; i < this.files.length; i++) {
                ...
                fileBloc.append('<span class="file-delete"><span><i class="bi bi-x"></i></span></span>').append(fileName);
                $("#file-selector-list> #file-selector-name").append(fileBloc);
            }
            for (let file of this.files) dt.items.add(file);
            this.files = dt.files;
            $("span.file-delete").click((function() {
